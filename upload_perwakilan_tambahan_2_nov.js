...
import dtt from "./data/NOV_TAMBAHAN_2_UPLOAD.json" assert { type: "json" };
...
const typeFileString = "PERWAKILAN";
const alokasi = "NOV_TAMBAHAN_2";
const alokasiString = "NOV";
...
function uploadDtt() {
  if (index < dtt.length) {
    ...
    const date = new Date(`11-${tanggal}-2023`);
